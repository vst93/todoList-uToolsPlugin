...
exports.default = function (config) {
  ...
  xl.file('workbook.xml', (0, _workbook2.default)(config.sheets));
  xl.file('_rels/workbook.xml.rels', (0, _workbookXml2.default)(config.sheets.length));
  zip.file('_rels/.rels', _rels2.default);
  zip.file('[Content_Types].xml', _Content_Types2.default);

  (config.sheets || []).forEach(function (sheet, ind) {
    var worksheet = generateXMLWorksheet(sheet.data);
